...
export declare function dataAzurermNetworkDdosProtectionPlanTimeoutsToTerraform(struct?: DataAzurermNetworkDdosProtectionPlanTimeoutsOutputReference | DataAzurermNetworkDdosProtectionPlanTimeouts | cdktf.IResolvable): any;
export declare class DataAzurermNetworkDdosProtectionPlanTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataAzurermNetworkDdosProtectionPlanTimeouts | undefined;
    set internalValue(value: DataAzurermNetworkDdosProtectionPlanTimeouts | undefined);
    private _read?;
    get read(): string;
...
*/
export declare class DataAzurermNetworkDdosProtectionPlan extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config: DataAzurermNetworkDdosProtectionPlanConfig);
    get id(): string;
    get location(): string;
    private _name?;
    get name(): string;
    ...
    private _timeouts;
    get timeouts(): DataAzurermNetworkDdosProtectionPlanTimeoutsOutputReference;
    putTimeouts(value: DataAzurermNetworkDdosProtectionPlanTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): DataAzurermNetworkDdosProtectionPlanTimeouts | undefined;

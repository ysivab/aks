...
export declare function sqlActiveDirectoryAdministratorTimeoutsToTerraform(struct?: SqlActiveDirectoryAdministratorTimeoutsOutputReference | SqlActiveDirectoryAdministratorTimeouts | cdktf.IResolvable): any;
export declare class SqlActiveDirectoryAdministratorTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): SqlActiveDirectoryAdministratorTimeouts | undefined;
    set internalValue(value: SqlActiveDirectoryAdministratorTimeouts | undefined);
    private _create?;
    get create(): string;
...
*/
export declare class SqlActiveDirectoryAdministrator extends cdktf.TerraformResource {
    ...
    */
    constructor(scope: Construct, id: string, config: SqlActiveDirectoryAdministratorConfig);
    ...
    private _timeouts;
    get timeouts(): SqlActiveDirectoryAdministratorTimeoutsOutputReference;
    putTimeouts(value: SqlActiveDirectoryAdministratorTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): SqlActiveDirectoryAdministratorTimeouts | undefined;
